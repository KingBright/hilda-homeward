...
b+=group(808,561,1,`${path(f.awning?'M-195-66 155-66 171-27-202-27Z':'M-195-66 155-66 171 73-202 73Z','#b89e6b','#36534e',3)}${rep(7,i=>path(f.awning?`M${-191+i*54}-64l-4 35h26l-3-35Z`:`M${-191+i*54}-64l-9 136h27l5-136Z`,i%2?'#899e83':'#c4b080'))}${path(f.awning?'M-202-27q28 24 54 0t54 0 54 0 54 0 54 0 54 0 49 0':'M-202 73q28 24 54 0t54 0 54 0 54 0 54 0 54 0 49 0','none','#304f4a',3)}`);
b+=path(`M962 388v${f.awning?278:204}`,'none','#b6a97b',5)+circle(962,398,16,'#4b6960','#c1b183',3)+group(962,f.awning?693:620,1,path('M-10-22Q-25 10 0 11T10-22Z','none','#ccb887',5));
...
b+=`<g transform="translate(0 ${f.gateOpen?-335:0})">${rep(9,i=>path(`M${1254+i*30} 336V799`,'none','#496c68',10))}${path('M1245 452h268M1245 605h268M1245 744h268','none','#557871',10)}</g>`;
b+=wheel(1169,603,55,(f.gateTurns||0)*65)+(!f.crankMounted?circle(1169,603,13,'#203f47'):path('M1169 603h38v-25','none','#dec493',8));
